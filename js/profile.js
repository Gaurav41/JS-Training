...
fname.addEventListener('change',()=>{
	if(fname.value == "")
	{
		...
		{	
			...
			err.innerHTML = "Invalid first name! Should contain only Alphabates & length equal to 4 or more";
			err.style.display = "block";
			fname.focus();
			return false;
		}
...
document.addEventListener("DOMContentLoaded",()=>{
	...
	var edit = document.getElementById("edit-profile-icon");
	edit.onclick = ()=>{
		var req = document.getElementsByClassName("requiredField");
